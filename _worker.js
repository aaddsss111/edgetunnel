...
let primarySub = 'alvless.comorg.us.kg'; // 主选
let backupSub = 'VLESS.fxxk.dedyn.io';   // 备选

// 根据某些条件选择其中一个域名
let sub = someCondition ? primarySub : backupSub;

console.log(sub); // 输出满足条件的域名
...
let addresses = [
	...
	/*
	'Join.my.Telegram.channel.CMLiussss.to.unlock.more.premium.nodes.cf.090227.xyz#111',
        '13.209.166.73:80'
	'visa.cn:443',
	'www.visa.com:8443',
	'cis.visa.com:2053',
